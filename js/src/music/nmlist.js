...
<style>
  ...
  #nmlist li {
    ...
    width: 180px;
    height: 180px;
    box-shadow: 8px 10px 20px #201d1d;
    border-radius: 10%;
    position: relative;
    cursor: pointer;
    transition: all 0.3s;
...
var nmlist = {
    "01":{
        ...
        "author": "mannana",
        "count":1,
        "cover": "http://p4.music.126.net/KG4t8UkdZoJt4BHc45ay9A==/18503681184431512.jpg"
    },
    "02":{
        "id": "02",
        "title": "影视原声",
        "author": "mannana",
        "count":1,
        "cover": "http://p1.music.126.net/5SLy8tkWPQ2VGugKP6ZtzQ==/1379887094024484.jpg"
    },
    "03":{
        "id": "03",
        "title": "好听音乐",
        "author": "mannana",
        "count":1,
        "cover": "http://p1.music.126.net/HuUTzinJo_PE9jU7vTUwog==/18897306346867803.jpg"
    },
//   "250819": {
//     "id": "250819",
...
var NM = {
  ...
  render: function() {
    ...
    var str = style + '<div id="nmlist"><h2>我的歌单</h2><i class="icon iconfont" data-start="&#xf001;" data-pause="&#xf053;"></i><div class="wrapper"><ul>';
